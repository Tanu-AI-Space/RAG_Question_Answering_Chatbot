...
![PDF Ingestion](images/Screenshot%202026-07-01%20at%208.09.46%20PM.png)
Shows real-time progress during the automated PDF ingestion and text extraction phase.

### 3. Index Building & Embedding
![Index Building](images/Screenshot%202026-07-01%20at%208.12.18%20PM.png)
Demonstrates the semantic embedding generation and FAISS index construction process.

### 4. Query Interface
![Query Interface](images/Screenshot%202026-07-01%20at%208.12.34%20PM.png)
Main Q&A chat interface where users type their research questions.

### 5. Citation Display
![Citation Display](images/Screenshot%202026-07-01%20at%208.12.42%20PM.png)
Answers with inline source citations `[1]`, `[2]`, `[3]`, `[4]` linked directly to source documents.

### 6. Full Q&A Log
![Q&A Log](images/Screenshot%202026-07-01%20at%208.13.12%20PM.png)
